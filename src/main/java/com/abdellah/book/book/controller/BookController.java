package com.abdellah.book.book.controller;

import com.abdellah.book.book.service.BookService;
...
public class BookController {
    ...
    @GetMapping("/owner")
    public ResponseEntity<Page<BookResponse>> findAllBooksByOwner(
            @RequestParam(name = "page", defaultValue = "0", required = false) int page,
            @RequestParam(name = "size", defaultValue = "10", required = false) int size,
            Authentication connectedUser
    ) {
    ...
    @GetMapping("/borrowed")
    public ResponseEntity<Page<BorrowedBookResponse>> findAllBorrowedBooks(
            @RequestParam(name = "page", defaultValue = "0", required = false) int page,
            @RequestParam(name = "size", defaultValue = "10", required = false) int size,
            Authentication connectedUser
    ) {
    ...
    @GetMapping("/returned")
    public ResponseEntity<Page<BorrowedBookResponse>> findAllReturnedBooks(
            @RequestParam(name = "page", defaultValue = "0", required = false) int page,
            @RequestParam(name = "size", defaultValue = "10", required = false) int size,
            Authentication connectedUser
    ) {
